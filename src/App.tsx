...
const testimonials = [
  ...
  {
    name: "Karina L.",
    text: "Fr fr ini jasa duplikat kunci paling reliable! Tengah malem kunci ilang mereka tetep ready, life saver bgt! Worth every penny 👏",
    rating: 5,
    tag: "Verified Customer ✓"
  }
];
